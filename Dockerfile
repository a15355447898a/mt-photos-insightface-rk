...
COPY inspireface-1.2.3-cp310-cp310-linux_aarch64.whl ./
RUN pip install --no-cache-dir rknn_toolkit_lite2-2.3.2-cp310-cp310-manylinux_2_17_aarch64.manylinux2014_aarch64.whl inspireface-1.2.3-cp310-cp310-linux_aarch64.whl
